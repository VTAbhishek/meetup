...
-- ------------------------------------------------------------
--  Mood tags. A company ticks the moods it suits; customers filter by
--  one of them after picking a district and city. A fixed vocabulary,
--  not free text — "late night" and "Late Night Spot" typed by two
--  venues would otherwise never match the same filter.
-- ------------------------------------------------------------
